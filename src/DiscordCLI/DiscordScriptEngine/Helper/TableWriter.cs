...
namespace DScriptEngine {
    class TableWriter {
        ...
        public TableWriter AddColumn(IEnumerable<string> names) {
            foreach (var name in names)
                Columns.Add(name);
            return this;
        }

        public TableWriter AddRow(params object[] values) {
            if (values == null)
        ...
        public static TableWriter From<T>(IEnumerable<T> values) {
        ...
        public void Write(FormatEnum format = FormatEnum.Default) {
            switch (format) {
                case FormatEnum.Default:
                    Console.WriteLine(ToString());
                    break;
                case FormatEnum.MarkDown:
                    Console.WriteLine(ToMarkDownString());
                    break;
                case FormatEnum.Alternative:
